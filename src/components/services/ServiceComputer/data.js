...
export const services = [
  {
    ...
    content: [
      { subcontent: "طراحی فروشگاه های آنلاین" },
      { subcontent: "سیستم های انبارداری و مالی" },
      { subcontent: "توسعه ی انواع نرم افزار ها و برنامه های تحت وب" },
    ],
  },

  {
    ...
    img: animationData2,
    content: [
      { subcontent: "بالا اوردن لینک وبسایت " },
      { subcontent: "فراگیری جدیدترین الگوریتم های گوگل " },
    ],
  },
  {
    id: 3,
    ...
    content: [
      { subcontent: "تیم تولید محتوای حرفه ای و متخصص" },
      { subcontent: "تولید محتوای مختص به کسب و کار شما" },
    ],
  },
  {
    id: 4,
    title: "پشتیبانی وبسایت",
    desc: "با توجه به توافق انجام شده در قرارداد تیم ما از محصول مربوطه تا مدت زمان تعیین شده پشتیبانی به عمل می اورذ",
   img: animationData4,

    content: [
      { subcontent: "رفع هرگونه خطا و باگ" },
      {
  ...
  },
  {
   ...
   img: animationData5,
    content: [
      { subcontent: "ارائه تمام نکات لازم برای انتخاب محصول" },
      { subcontent: "راهنمایی کارفرما در طول مسیر" },
    ],
  },
];
