...
const Mobile_Scroll = () => {
  ...
  <Grid sx={{position:"relative",width:"100%",height:"100%"}}>
    ...
    <Grid sx={{overflowY:"scroll",display:"block",width:"94%",margin:"2rem auto 0px",zIndex:"4",right:'0',borderRadius:{xs:"20px 20px 20px 20px",md:"60px 60px 60px 60px"},backgroundColor:"rgb(0,0,0)",height:{xs:"8%",md:"9%"}}}>
